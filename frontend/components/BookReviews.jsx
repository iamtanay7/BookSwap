...
const BookReviews = () => {
  return (
    <div>
      <div className="w-[665px] h-full p-2 bg-[#F3F3F3] rounded-md">
        <Carousel
        ...
        >
          ...
          <div className="flex flex-col justify-start text-start ">
            ...
            <div className="w-[634px] text-black text-[16px] font-normal pl-4 pb-4">
              ...
              personal well-being. Jake Knapp and John Zeratsky have crafted an
              exceptional guide that offers practical strategies and insightful
              advice on how to reclaim control of our time and live more
              intentionally.
            </div>
          </div>
          <div className="flex flex-col justify-start text-start ">
